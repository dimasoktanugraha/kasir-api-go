...
func (repo *ProductRepository) GetAll() ([]models.Product, error) {
	...
	for rows.Next() {
		...
		err := rows.Scan(&p.ID, &p.Name, &p.Price, &p.Stock, &p.CategoryID, &p.CategoryName, &p.CategoryDesc)
		if err != nil {
			return nil, err
		}
...
func (repo *ProductRepository) GetByID(id int) (*models.Product, error) {
	...
	var p models.Product
	err := repo.db.QueryRow(query, id).Scan(&p.ID, &p.Name, &p.Price, &p.Stock, &p.CategoryID, &p.CategoryName, &p.CategoryDesc)
